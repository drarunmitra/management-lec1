...
## Summary {.inverse background-color="black"}

![](images/Health-Planning-Cycle-Johnson-2008.png)
# Thank You!
...
- Ensures adequate supply without excessive oversupply
- Aims to have the right amount of materials at the right place, time, and cost

---

## Importance of Inventory Control

- Inventories can represent 50-70% of capital investment
- Balancing act:
  - Too low: Risk of delays in fulfilling orders
  - Too high: Ties up capital, risk of obsolescence and spoilage
- In hospitals: ~1/3 of annual budget spent on medicines
...
2. VED Analysis
3. ABC-VED Matrix
4. Fixed Order Size System (Q-system)
5. Fixed Order Interval System (T-system)
...
- Categorizes items based on annual consumption value:
...
- Categorizes items based on criticality:
  - Vital (V): Critical for patient survival
  - Essential (E): Lower critical need
  - Desirable (D): Lowest criticality
...
graph TD
    A[Inventory Items] --> B[Vital]
    A --> C[Essential]
    A --> D[Desirable]
    B --> E[Critical for patient survival]
    C --> F[Lower critical need]
    D --> G[Lowest criticality]
```


## ABC-VED Matrix

- Combines ABC and VED analyses
- Helps prioritize items for management attention:
  - Category I: High priority (AV, BV, CV, AE, AD)
  - Category II: Moderate priority (BE, CE)
  - Category III: Low priority (CD)
...
```{mermaid}
graph TD
    A[ABC-VED Matrix] --> B[Category I]
    A --> C[Category II]
    A --> D[Category III]
    B --> E[High Priority]
    C --> F[Moderate Priority]
    D --> G[Low Priority]
    E --> H[AV, BV, CV, AE, AD]
    F --> I[BE, CE]
    G --> J[CD]
...
## Fixed Order Size System (Q-system)

- Order size (Q) is fixed
- Time between orders may vary
- Reorder point determined by usage rate and lead time
...
```{mermaid}
graph LR
    A[Inventory Level] --> B[Reorder Point]
    B --> C[Place Order]
    C --> D[Fixed Order Size Q]
    D --> E[Receive Order]
    E --> A
```

## Fixed Order Interval System (T-system)

- Time between orders (T) is fixed
- Order size varies to reach maximum stock level
...
```{mermaid}
graph LR
    A[Fixed Time Interval] --> B[Review Inventory]
    B --> C[Calculate Order Size]
    C --> D[Place Order]
    D --> E[Receive Order]
    E --> A
```
...
## Minimum/Maximum Inventory Control

- Helps avoid stock-outs, inadequate stock, and excess stock
- Key levels:
  - Maximum stock level (Ideal Inventory)
  - Minimum stock (Reorder level/point)
  - Buffer stock (Safety Stock)

---

![](images/inventory_reorder.png)

---

![](images/inventory_reorder_2.png)
...
- Reduces risk of expiration and obsolescence
- Ensures availability of critical items
...
- Diverse range of items (pharmaceuticals, medical supplies, equipment)
- Critical nature of many items
...
```{mermaid}
flowchart LR
    A[Inventory Control Technologies] --> B[Barcode Systems]
    A --> C[RFID Technology]
    A --> D[Automated Dispensing Cabinets]
    A --> E[Inventory Management Software]
    A --> F[EHR Integration]
    B & C & D & E --> G[Real-time Tracking]
    E & F --> H[Data Analytics]
```

## Best Practices

1. Regular audits and cycle counting
2. Use of data analytics for demand forecasting
3. Collaboration with suppliers
4. Staff training on inventory management
5. Lean inventory management principles
...
- Effective inventory control is crucial for healthcare organizations
- Balances cost efficiency with patient care quality
- Requires a combination of techniques and technologies
- Continuous monitoring and adaptation are key to success

## Additional Resources

Gupta R, Gupta KK, Jain BR, Garg RK. ABC and VED Analysis in Medical Stores Inventory Control. Med J Armed Forces India. 2007 Oct;63(4):325-7. doi: 10.1016/S0377-1237(07)80006-2. Epub 2011 Jul 21. PMID: 27408040; PMCID: PMC4922040.

<https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4922040/pdf/main.pdf>
